/*! wPaint - v2.2.0 - 2013-10-23 */!function(a) {
    ...
    b.prototype = {generate: function() {
            ...
            function e() {
                var a = 1, b = 0, e = 0, i = 0, j = 0, k = g.width, l = g.height;
        ...
        for (f in a)
            e(f)
    }, a.fn.wPaint.menus = {}, a.fn.wPaint.cursors = {}, a.fn.wPaint.defaults = {path: "/", theme: "standard classic", autoScaleImage: !0, autoCenterImage: !0, menuHandle: !0, menuOrientation: "horizontal", menuOffsetLeft: 5, menuOffsetTop: 5, bg: null, image: null, onShapeDown: null, onShapeMove: null, onShapeUp: null}
}(jQuery), function() {
    ...
    a.fn.realWidth = function(b, c, d) {
        ...
        a(this).on("touchstart touchmove touchend touchcancel", function() {
            var a = event.changedTouches, b = a[0], c = "";
            switch (event.type) {
                case"touchstart":
                    c = "mousedown";
                    break;

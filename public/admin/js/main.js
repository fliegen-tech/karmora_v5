...
var Core = function() {
    ...
    var runPrepJS = function() {
        ...
        $(window).load(function() {
            ...
            var scripts = {
                // HIGH PRIORITY
                gmap: base_url+'/admin/public/admin/vendor/plugins/map/gmaps.min.js',
                jquerymap: base_url+'/public/admin/vendor/plugins/gmap/jquery.ui.map.js',
                mixitup: base_url+'/public/admin/vendor/plugins/mixitup/jquery.mixitup.min.js',
                mpopup: base_url+'/public/admin/vendor/plugins/mfpopup/dist/jquery.magnific-popup.min.js',
                chosen: base_url+'/public/admin/vendor/plugins/chosen/chosen.jquery.min.js',
                moment: base_url+'/public/admin/vendor/plugins/daterange/moment.min.js',
                globalize: base_url+'/public/admin/vendor/plugins/globalize/globalize.js',
                // FORM PICKERS
                cpicker: base_url+'/public/admin/vendor/plugins/colorpicker/bootstrap-colorpicker.js',
                timepicker: base_url+'/public/admin/vendor/plugins/timepicker/bootstrap-timepicker.min.js',
                datepicker: base_url+'/public/admin/vendor/plugins/datepicker/bootstrap-datepicker.js',
                daterange: base_url+'/public/admin/vendor/plugins/daterange/daterangepicker.js',
                // FORMS
                validate: base_url+'/public/admin/vendor/plugins/validate/jquery.validate.js',
                masked: base_url+'/public/admin/vendor/plugins/jquerymask/jquery.maskedinput.min.js',
                // FORMS TOOLS
                holder: base_url+'/public/admin/vendor/bootstrap/holder.js',
                tagmanager: base_url+'/public/admin/vendor/plugins/tags/tagmanager.js',
                gritter: base_url+'/public/admin/vendor/plugins/gritter/js/jquery.gritter.min.js',
                ladda: base_url+'/public/admin/vendor/plugins/ladda/ladda.min.js',
                switcher: base_url+'/public/admin/vendor/plugins/formswitch/js/bootstrap-switch.min.js',
                paginator: base_url+'/public/admin/vendor/bootstrap/paginator/src/bootstrap-paginator.js',
                knob: base_url+'/public/admin/vendor/plugins/jquerydial/jquery.knob.js',
                rangeslider: base_url+'/public/admin/vendor/plugins/rangeslider/jQAllRangeSliders.min.js',
                // MED PRIORITY - Large File sizes
                charts: base_url+'/public/admin/js/charts.js',
                ckeditorCDN: base_url+'/https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
                xedit: base_url+'/public/admin/vendor/editors/xeditable/js/bootstrap-editable.js',
                summernote: base_url+'/public/admin/vendor/editors/summernote/summernote.js',
                elfinder: base_url+'/public/admin/vendor/plugins/elfinder/js/elfinder.min.js',
                countdown: base_url+'/public/admin/vendor/plugins/countdown/jquery.countdown.js',
                jcrop: base_url+'/public/admin/vendor/plugins/imagecrop/js/jquery.Jcrop.min.js',
                imagezoom: base_url+'/public/admin/vendor/plugins/imagezoom/jquery.elevatezoom.min.js',
                sketchpad: base_url+'/public/admin/vendor/plugins/notepad/wPaint.min.js',
                scrollto: base_url+'/public/admin/vendor/plugins/scrollto/jquery.scrollTo-1.4.3.1-min.js',
                fileupload: base_url+'/public/admin/vendor/bootstrap/fileupload/fileupload.js',
                fitvids: base_url+'/public/admin/vendor/plugins/fitvids/jquery.fitvids.js',
                // LARGE IMAGES
                image1: base_url+'/public/img/stock/22.jpg',
                image2: base_url+'/public/img/stock/21.jpg'
            };

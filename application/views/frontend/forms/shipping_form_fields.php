<div class="row">
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        ...
        <input type="text" required="required" name="shipping_detail[street_address]" class="form-control" id="address1" placeholder="Address1">
        <span class="error_message_class"><?php echo form_error('shipping_detail[street_address]'); ?></span>
    </div>
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        <label for="address2">Address 2 </label>
        <input type="text" name="shipping_detail[street_address_2]" class="form-control"  placeholder="Address2">
    </div>
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        <label for="city">City <span class="important-input">*</span></label>
        <input required="required" type="text" name="shipping_detail[city]" class="form-control" placeholder="City">
    ...
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        ...
        <select required="required" id="statesList" name="shipping_detail[state]" class="form-control">
        ...
        <span
            class="error_message_class"><?php echo form_error('shipping_detail[state]'); ?></span>
    </div>
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        <label required="required" for="zipcode">Zip Code <span  class="important-input">*</span></label>
        <input type="text" name="shipping_detail[zipcode]" class="form-control" value="<?php echo set_value('shipping_detail[zipcode]'); ?>" id="zipcode" placeholder="Zip Code">
    ...
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        ...
        <select required="required" id="countriesList" name="shipping_detail[country]" placeholder="Country" class="form-control"
    ...
    <div class="form-group col-md-6 col-sm-6 revamp-padding">
        ...
        <input type="text" required="required" name="shipping_detail[phone]" class="form-control"  value="<?php echo set_value('shipping_detail[phone]'); ?>" placeholder="Phone">

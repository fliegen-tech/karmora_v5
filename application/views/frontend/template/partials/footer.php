            ...
            <div class="col-3">
                <div class="footer-link-box">
                    ...
                    <ul class="list-unstyled services-footer">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#cash-back-gurantee">Best Cash Back Guarantee</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-3">
                    ...
                    <div class="footer-social">
                        <ul class="connect-social list-unstyled">
                            ...
                            <li><a target="_blank" href="https://plus.google.com/u/0/+ShopKarmora/posts"><i
                                            class="fa fa-bold" aria-hidden="true"></i></a></li>
...
if ( isset( $modals ) && ! empty( $modals ) ) {
    foreach ( $modals as $key => $val ) {
        $model = $this->load->view('frontend/template/partials/popups/'.$val);
    }
}
?>
<!-- jQuery -->

<div class="navbar-header">
    <nav id="topNav" class="navbar fixed-to navbar-expand-lg navbar-light navbar-inverse bg-inverse">
    	<div class="karmora-header">
        ...
        <!-- Mobile Screen Responsive -->
        	<div class="mobile-screen">
	                <li class="nav-item">
	                    <a class="nav-link" href="<?php echo base_url().'supplement-product'; ?>">Dietary Supplements</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link" href="<?php echo base_url().'flawless-product'; ?>">Flawless Skincare</a>
	                </li>
                    <li class="nav-item">
	                    <a class="nav-link" href="<?php echo base_url().'share'; ?>">Make Money</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link" href="<?php echo base_url().'karmora-cash-back'; ?>">Cash Back</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link" href="<?php echo base_url().'about-us'; ?>">About Karmora</a>
	                </li>
